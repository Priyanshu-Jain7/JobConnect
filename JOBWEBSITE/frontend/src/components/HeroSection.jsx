  ...
  return (
      ...
      <div className="text-center">
        <div className="flex flex-col gap-5 my-10">
          ...
          <p>Fuck Fuck Fuck Go find a Job You pisky Brat Do some Work Asshole </p>

          <div className="flex w[40%] shadow-lg border border-gray-200 pl-3 rounded-full items-center gap-4 mx-auto">
            <input type="text" placeholder="Find your dream job" className="outline-none flex-1 border-none w-full" />
