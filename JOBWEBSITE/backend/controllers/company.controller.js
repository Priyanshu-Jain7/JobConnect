...
export const registerCompany=async(req,res)=>{
    try{
        ...
        company = await Company.create({name:companyName,success:true});
...
export const updateCompany= async(req,res)=>{
    try{
        const {name, descriptionn,website,location} = req.body;
        const file=req.file;

        const updateData={name,descriptionn,website,location};
